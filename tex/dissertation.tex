...
% Set up some values.
\completetitle{On Entropy and Restricted Exchange: Market Reactions to Change in the Distribution of Field-Level Information}
\fullname{Jameson K. M. Watts}			% Grad college wants your full name here.
...
\maketitlepage
{DEPARTMENT OF MARKETING, ELLER COLLEGE OF MANAGEMENT}	% Title of your department.
{2015}							
...
\approval
{20 April 2015}		% Defense Date	
{Robert F. Lusch}	% Dissertation Director
{Ronald L. Breiger}	% 1st committee member
{Kenneth W. Koput}		% 2nd committee member
{Walter W. Powell}		% 3rd committee member
{Frederick E. Webster Jr.}		% 4th committee member
