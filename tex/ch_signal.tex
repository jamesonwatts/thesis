...
\begin{table}[htbp]\centering \caption{Regression of R\&D on Centrality\label{r8}}
{
\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
\begin{tabular}{l*{3}{c}}
\hline\hline
...
For biotechnology firms, centrality leads to increases in the nonoperating income linked to research grants and licensing deals. However, this advantage is only present under high language uncertainty as illustrated in Figure \ref{canopy}. In the years following the research by Powell et al. (1999), uncertainty in the biotech industry dropped. This may have emboldened investors to place bets on less established firms. The presence of main effects in the original study thus become a matter of research timing and misses a crucial moderating factor.

\begin{figure}
\begin{center}
\includegraphics[scale=.5]{../figures/CentralityNopi.png}
...
Centrality has a substantive advantage for biotechnology firms in the selection of R\&D partners. However, this advantage disappears when language uncertainty passes the 3rd quantile of in-sample values as shown in Figure \ref{crd}. The fact that advantage persists until uncertainty is quite high suggests that one could still find a main effect in periods of relatively high uncertainty as occurred in the original two studies.

\begin{figure}
\begin{center}
\includegraphics[scale=.5]{../figures/CentralityRD.png}
...
Centrality's advantage in relation to stock returns appears in the form of liability mitigation. Central firms are larger, older and thus, may grow at a slower rate than smaller or younger firms. If these central firms were unable to use the information and resources at their disposal because of a favorable network position, centrality might have a negative main effect on abnormal returns. As it stands, the effect is neutral; however, as language uncertainty increases, central firms find it more difficult to use the information flowing across network ties and the liability of maturity reveals itself in the negative interaction.

Table \ref{summary} summarizes my empirical results. 
...
Symbolic \\ \hline
Centrality $\rightarrow$ Nonop. Inc. & No & Yes & Yes\\
Nonop. Income $\rightarrow$ Emps. & Yes\\
Centrality $\rightarrow$ Nonop. Inc. $\rightarrow$ Emps. & No & Yes\\
Nonop. Income $\rightarrow$ Sales & No\\
Centrality $\rightarrow$ Nonop. Inc. $\rightarrow$ Sales & No & Yes\\
\hline
Substantive \\ \hline
Centrality $\rightarrow$ Patents & No & No & Yes\\
R\&D $\rightarrow$ Centrality $\rightarrow$ Patents & Yes\\
Centrality $\rightarrow$ Abnorm. Ret. & No & Yes & Yes\\
R\&D $\rightarrow$ Centrality $\rightarrow$ Aret & No\\
Centrality $\rightarrow$ R\&D Ties & Marginal & Yes & Yes\\
\hline \hline 
 \end{tabular}
\end{table}
%\end{landscape}
