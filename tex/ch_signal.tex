...
\begin{table}[htbp]\centering \caption{Regression of Patents and Ab. Ret. on Unc. x Centrality\label{r7}}
{
\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
\begin{tabular}{l*{2}{c}}
\hline\hline
...
\multicolumn{1}{c}{Relationship} & Reproduced & Resolved by (Unc. x Cent.) & Hypothesized \\ \hline
Symbolic \\ \hline
Centrality $\rightarrow$ Nonop. Income & No & Yes & Yes\\
Nonop. Income $\rightarrow$ Employees & Yes\\
Centrality $\rightarrow$ Nonop. Income $\rightarrow$ Employees & No & Yes\\
Nonop. Income $\rightarrow$ Sales & No\\
Centrality $\rightarrow$ Nonop. Income $\rightarrow$ Sales & No & Yes\\
\hline
Substantive \\ \hline
