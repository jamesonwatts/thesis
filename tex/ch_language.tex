...
\begin{figure}[p!]
\begin{center}
\includegraphics[scale=.55]{../figures/zipf1.png}
...
\begin{figure}[p!]
\begin{center}
\includegraphics[scale=.55]{../figures/zipf2.png}
...
\begin{figure}[p!]
\begin{center}
\includegraphics[scale=.5]{../figures/lcon1.png}
...
\begin{figure}[p!]
\begin{center}
\includegraphics[scale=.5]{../figures/lcon2.png}
...
\begin{figure}[p!]
\begin{center}
\includegraphics[scale=.5]{../figures/lcon3.png}
\caption[Monthly Language Consistency, Levels and Differences (1993-2004)]{Monthly Language Consistency in Levels and First Differences (1993-2004)\label{lcon2}}
\end{center}
\end{figure}
\end{landscape}
