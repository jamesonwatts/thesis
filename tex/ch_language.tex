...
Despite these intriguing results, many questions remain. For instance, what is the relationship (if any) between language consistency and industry-wide price volatility (i.e. systematic risk)? I also expect some degree of heterogeneity at the firm level. In Chapter \ref{signal}, I address these questions by building and testing theory on the relationship between language consistency, environmental uncertainty and structural signals of quality. Language consistency is shown to have an effect on firm abnormal returns contingent on the firm's position in a network of strategic alliances.
