...
with con:
    cur = con.cursor()    
    with open('/Users/research/GDrive/Dissertation/thesis/stata/dyngrph_mo.csv', 'wb') as csvfile:
        bwriter = csv.writer(csvfile, delimiter=',')
        bwriter.writerow(['year','month','pid','tied','pscore','avg_clstr','nodes','edges'])
...
#                for pair in pairs:
#                    a,b,p = pair       
#                    bwriter.writerow([str(year)[0:4],str(a)+","+str(b),int(g.has_edge(a,b)),p,c,n,e])            
